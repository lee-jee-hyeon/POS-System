...
public class Tables extends JFrame{
	...
	private JButton mainmenubt = new JButton("브런치");
	private JButton sidemenubt = new JButton("사이드");
	private JButton coffeebt = new JButton("커피");
	private JButton sandwichbt = new JButton("샌드위치");
	private JButton drinkbt = new JButton("쥬스&음료");
	private JButton change_bt = new JButton("수정");
	private JButton order_bt = new JButton("주문");
	...
	private void jtableset() {
		...
		jTable.setFont(new Font("12롯데마트드림Bold", Font.BOLD, 30));
	...
	private void menuset(String str) {
		...
		tablename_label = new JLabel("Table "+ str.substring(6,7));
		tablename_label.setForeground(new Color(0, 0, 0));
		tablename_label.setFont(new Font("12롯데마트드림Bold", Font.BOLD, 65));
		...
		menu2.setFont(new Font("12롯데마트드림Bold", Font.BOLD, 18));
		...
		menu3.setFont(new Font("12롯데마트드림Bold", Font.BOLD, 18));
		...
		menu4.setFont(new Font("12롯데마트드림Bold", Font.BOLD, 18));
		...
		menu5.setFont(new Font("12롯데마트드림Bold", Font.BOLD, 18));
		...
		menu6.setFont(new Font("12롯데마트드림Bold", Font.BOLD, 18));
		...
		menu7.setFont(new Font("12롯데마트드림Bold", Font.BOLD, 18));
		...
		menu8.setFont(new Font("12롯데마트드림Bold", Font.BOLD, 18));
		...
		menu9.setFont(new Font("12롯데마트드림Bold", Font.BOLD, 18));
		...
		menu1.setFont(new Font("12롯데마트드림Bold", Font.BOLD, 18));
	...
	private void menu_bt(String str, PosMain posmain) {
		...
		mainmenubt.setFont(new Font("12롯데마트드림Bold", Font.PLAIN, 17));
		...
		sidemenubt.setFont(new Font("12롯데마트드림Bold", Font.PLAIN, 17));
		sidemenubt.setBounds(12, 158, 160, 70);
		menu_panel.add(sidemenubt);

		
		coffeebt.setBackground(new Color(255, 218, 185));
		coffeebt.setForeground(new Color(34, 139, 34));
		coffeebt.setFont(new Font("12롯데마트드림Bold", Font.PLAIN, 17));
		coffeebt.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					menueffect(3);
				} catch (IOException e1) {
		...
		coffeebt.setBounds(12, 363, 160, 70);
		menu_panel.add(coffeebt);

		
		sandwichbt.setBackground(new Color(255, 218, 185));
		sandwichbt.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					menueffect(4);
				} catch (IOException e1) {
		...
		sandwichbt.setForeground(new Color(0, 0, 205));
		sandwichbt.setFont(new Font("12롯데마트드림Bold", Font.PLAIN, 17));
		sandwichbt.setBounds(12, 468, 160, 70);
		menu_panel.add(sandwichbt);

		
		drinkbt.setBackground(new Color(255, 218, 185));
		drinkbt.setForeground(new Color(255, 215, 0));
		drinkbt.setFont(new Font("12롯데마트드림Bold", Font.PLAIN, 17));
		...
		drinkbt.setBounds(12, 254, 160, 70);
		...
		order_bt.setFont(new Font("12롯데마트드림Bold", Font.BOLD, 46));
		...
		cancel_bt.setFont(new Font("12롯데마트드림Bold", Font.BOLD, 46));
